module.exports = function(grunt) { 
    ...
    var out         = 'output/ltiTestConsumer';
    ...
    copy.ltitestconsumerbundle = {
        files: [
            { src: [out + '/ltiTestConsumer/controller/routes.js'],  dest: root + '/ltiTestConsumer/views/js/controllers.min.js' },
            { src: [out + '/ltiTestConsumer/controller/routes.js.map'],  dest: root + '/ltiTestConsumer/views/js/controllers.min.js.map' }
        ]
    };
