	...
	implements taoTests_models_classes_TestModel
{
    ...
    public function prepareContent( core_kernel_classes_Resource $test, $items = array()) {
        ...
        $test->setPropertyValue(new core_kernel_classes_Property(TestService::TEST_TESTCONTENT_PROP), $content);
    }
    ...
    public function deleteContent( core_kernel_classes_Resource $test) {
    	...
    	if (!is_null($content)) {
    		$content->delete();
    		$test->removePropertyValue(new core_kernel_classes_Property(TestService::TEST_TESTCONTENT_PROP), $content);
    	}
    }
